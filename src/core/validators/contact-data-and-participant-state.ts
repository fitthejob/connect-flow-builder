...
export function validateUpdatePreviousContactParticipantStateAction(action: FlowAction): void {
...
export function validateUpdateContactDataAction(action: FlowAction): void {
...
export function validateRangeStringParameter(
  action: FlowAction,
  key: string,
  min: number,
  max: number,
