...
export function validateAssociateContactToCustomerProfileAction(action: FlowAction): void {
...
export function validateDequeueContactAndTransferToQueueAction(action: FlowAction): void {
...
export function validateTransferContactToAgentAction(action: FlowAction): void {
