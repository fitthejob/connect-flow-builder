...
import {
  validateUpdateContactMediaProcessingAction,
  validateUpdateContactMediaStreamingBehaviorAction,
  validateUpdateContactRecordingAndAnalyticsBehaviorAction,
  validateUpdateFlowLoggingBehaviorAction,
} from "./analyze.js";
import {
  validateConnectParticipantWithLexBotAction,
  validateCreateWisdomSessionAction,
} from "./bot-and-assistant-internals.js";
import {
  validateCheckHoursOfOperationAction,
  validateCheckMetricDataAction,
  validateCheckOutboundCallStatusAction,
  validateCheckVoiceIdAction,
  validateCompareAction,
  validateGetMetricDataAction,
} from "./check.js";
import {
  validateUpdateContactDataAction,
  validateUpdatePreviousContactParticipantStateAction,
} from "./contact-data-and-participant-state.js";
import {
  validateUpdateFlowAttributesAction,
} from "./flow-state-and-execution-internals.js";
import {
  validateCreateCaseAction,
  validateCreateCustomerProfileAction,
  validateEvaluateDataTableValuesAction,
  validateGetCalculatedAttributesForCustomerProfileAction,
  validateGetCaseAction,
  validateGetCustomerProfileAction,
  validateGetCustomerProfileObjectAction,
  validateInvokeFlowModuleAction,
  validateListDataTableValuesAction,
  validateShowViewAction,
  validateUpdateCaseAction,
  validateUpdateCustomerProfileAction,
  validateUpsertDataTableValuesAction,
} from "./integrate.js";
import {
  validateAuthenticateParticipantAction,
  validateCreatePersistentContactAssociationAction,
...
import {
  validateCompleteOutboundCallAction,
  validateCreateCallbackContactAction,
  validateStartOutboundChatContactAction,
} from "./outbound-and-callback-operations.js";
import {
  validateMessageParticipantIterativelyAction,
} from "./queue-and-hold-messaging.js";
import {
  validateAssociateContactToCustomerProfileAction,
  validateDequeueContactAndTransferToQueueAction,
  validateTransferContactToAgentAction,
} from "./routing-and-transfer-internals.js";
import {
  validateResumeContactAction,
  validateStartVoiceIdStreamAction,
  validateTagContactAction,
  validateUnTagContactAction,
  validateUpdateContactCallbackNumberAction,
  validateUpdateContactEventHooksAction,
  validateUpdateContactRoutingBehaviorAction,
  validateUpdateContactTargetQueueAction,
  validateUpdateContactTextToSpeechVoiceAction,
  validateUpdateRoutingCriteriaAction,
} from "./set.js";
import {
  validateEndFlowExecutionAction,
  validateEndFlowModuleExecutionAction,
  validateTransferContactToQueueAction,
  validateTransferParticipantToThirdPartyAction,
  validateTransferToFlowAction,
} from "./terminate.js";
