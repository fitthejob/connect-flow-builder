...
export function validateStartVoiceIdStreamAction(action: FlowAction): void {
...
export function validateResumeContactAction(action: FlowAction): void {
  if (Object.keys(action.parameters).length > 0) {
    throw new Error(
...
export function validateTagContactAction(action: FlowAction): void {
...
export function validateUpdateContactEventHooksAction(action: FlowAction): void {
...
export function validateUnTagContactAction(action: FlowAction): void {
...
export function validateUpdateContactCallbackNumberAction(action: FlowAction): void {
...
export function validateUpdateContactRoutingBehaviorAction(action: FlowAction): void {
...
export function validateUpdateContactTargetQueueAction(action: FlowAction): void {
...
export function validateUpdateContactTextToSpeechVoiceAction(action: FlowAction): void {
...
export function validateUserDefinedTagEntry(
  action: FlowAction,
  key: string,
  value: unknown,
...
export function isLikelyJsonPath(value: string): boolean {
  return /^\$(\.|\[)/.test(value);
}

export function validateUpdateRoutingCriteriaAction(action: FlowAction): void {
...
export function validateRoutingCriteriaStep(action: FlowAction, step: RoutingCriteriaStep): void {
...
export function validateRoutingCriteriaAttributeCondition(
  action: FlowAction,
