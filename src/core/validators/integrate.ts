...
export function validateCreateCaseAction(action: FlowAction): void {
...
export function validateCreateCustomerProfileAction(action: FlowAction): void {
  validateProfileRequestDataHasEntries(action);
  validateProfileResponseData(action);
  requireErrorTypes(action, ["NoMatchingError"]);
}

export function validateEvaluateDataTableValuesAction(action: FlowAction): void {
...
export function validateInvokeFlowModuleAction(action: FlowAction): void {
  requireNonEmptyStringParameter(action, "FlowModuleId");
}

export function validateGetCaseAction(action: FlowAction): void {
  validateLowercaseBooleanStringParameter(action, "LinkContactToCase");
...
export function validateGetCustomerProfileAction(action: FlowAction): void {
...
export function validateGetCustomerProfileObjectAction(action: FlowAction): void {
  const requestData = requireObjectParameter(action, "ProfileRequestData");
...
export function validateListDataTableValuesAction(action: FlowAction): void {
  requireNonEmptyStringParameter(action, "DataTableId");
  requireErrorTypes(action, ["NoMatchingError"]);
...
export function validateGetCalculatedAttributesForCustomerProfileAction(action: FlowAction): void {
  const requestData = requireObjectParameter(action, "ProfileRequestData");
  if (
    typeof requestData.ProfileId !== "string"
    || requestData.ProfileId.trim().length === 0
...
export function validateUpsertDataTableValuesAction(action: FlowAction): void {
...
export function validateUpdateCaseAction(action: FlowAction): void {
  validateLowercaseBooleanStringParameter(action, "LinkContactToCase");
...
export function validateUpdateCustomerProfileAction(action: FlowAction): void {
  validateProfileRequestDataHasEntries(action);
  validateProfileResponseData(action);
  requireErrorTypes(action, ["NoMatchingError"]);
}

export function validateStringArrayParameter(action: FlowAction, key: string): void {
...
export function requireArrayParameter(
  action: FlowAction,
  key: string,
...
export function requireNestedArray(
  action: FlowAction,
...
export function validateArrayLengthRange(
  action: FlowAction,
  value: unknown[],
  fieldName: string,
  actionType: FlowAction["type"],
...
export function validateNestedStringArray(
  action: FlowAction,
  parent: Record<string, unknown>,
  key: string,
  parentName: string,
...
export function validateNamedPrimaryValues(
  action: FlowAction,
  parent: Record<string, unknown>,
  key: string,
  nameKey: string,
...
export function validateLowercaseBooleanStringParameter(action: FlowAction, key: string): void {
...
export function validateProfileRequestDataHasEntries(action: FlowAction): void {
  const requestData = requireObjectParameter(action, "ProfileRequestData");
...
export function validateProfileResponseData(action: FlowAction): void {
...
export function validateCustomerProfileSearchCriteria(
  action: FlowAction,
  criteria: unknown[],
): void {
...
export function validateShowViewAction(action: FlowAction): void {
